...
import type {CalendarBookingStepType} from "../components/calendar-booking-types";
...
import {DurationEnum, durations, type TimeSlot} from "../components/calendar";
import CalendarTimeSelect from "../components/calendar-time-select";
import CalendarBookingForm from "../components/calendar-booking-form";
import CalendarBookingConfirmation from "../components/calendar-booking-confirmation";
...
export default function CalendarBooking() {
  ...
  const [paciente, setPaciente] = useState<string>("Zoey Lang");
